...
--------------------------------------------------------
--  DDL for Trigger BOR_BORD_LOG_ENTRY_TRG
--------------------------------------------------------

  CREATE OR REPLACE TRIGGER "FLIGHT_DEV"."BOR_BORD_LOG_ENTRY_TRG" 
BEFORE INSERT ON BOR_BORD_LOG_ENTRY 
FOR EACH ROW 
BEGIN
  <<COLUMN_SEQUENCES>>
  BEGIN
    IF INSERTING AND :NEW.PK_BOR_BORD_LOG_ENTRY IS NULL THEN
      SELECT BOR_BORD_LOG_ENTRY_SEQ1.NEXTVAL INTO :NEW.PK_BOR_BORD_LOG_ENTRY FROM SYS.DUAL;
    END IF;
  END COLUMN_SEQUENCES;
END;
/
ALTER TRIGGER "FLIGHT_DEV"."BOR_BORD_LOG_ENTRY_TRG" ENABLE;
--------------------------------------------------------
...
--------------------------------------------------------
--  DDL for Trigger BOR_BORD_LOG_TRG1
--------------------------------------------------------

  CREATE OR REPLACE TRIGGER "FLIGHT_DEV"."BOR_BORD_LOG_TRG1" 
BEFORE INSERT ON BOR_BORD_LOG 
FOR EACH ROW 
BEGIN
  <<COLUMN_SEQUENCES>>
  BEGIN
    IF INSERTING AND :NEW.PK_BOR_BORD_LOG IS NULL THEN
      SELECT BOR_BORD_LOG_SEQ2.NEXTVAL INTO :NEW.PK_BOR_BORD_LOG FROM SYS.DUAL;
    END IF;
  END COLUMN_SEQUENCES;
END;
/
ALTER TRIGGER "FLIGHT_DEV"."BOR_BORD_LOG_TRG1" ENABLE;
--------------------------------------------------------
